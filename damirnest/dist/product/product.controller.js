...
let ProductController = class ProductController {
	...
	async get(id) {
		...
		if (!product) {
			throw new common_1.NotFoundException(product_constants_1.ProductByIdNotFount);
		}
		return product;
	}
	async delete(id) {
	...
	async patch(id, dto) {
		...
		if (!UpdatedProduct) {
			throw new common_1.NotFoundException(product_constants_1.ProductIdNotFoundForUpd);
		}
